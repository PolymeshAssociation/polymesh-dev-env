...
export class Portfolios {
  ...
  public async deletePortfolio(
    ...
    return this.client.postDelete(
      `/identities/${did}/portfolios/${portfolioId}/delete`,
      txBase
    );
  }
  ...
  public async modifyPortfolioName(
    ...
    return this.client.post(
      `/identities/${did}/portfolios/${portfolioId}/modify-name`,
      params
    );
  }
  ...
  public async setCustodian(
    ...
    return this.client.post(
      `/identities/${did}/portfolios/${portfolioId}/custodian`,
      params
    );
  }
  ...
  public async getTransactionHistory(
    ...
    return this.client.get(
      `/identities/${did}/portfolios/${portfolioId}/transactions`
    );
  }
  ...
  public async quitCustody(
    ...
    return this.client.post(
      `/identities/${did}/portfolios/${portfolioId}/quit-custody`,
      {
        ...txBase,
      }
    );
  ...
  public async createdAt(
    ...
    return this.client.get(
      `/identities/${did}/portfolios/${portfolioId}/created-at`
    );
  }
}
